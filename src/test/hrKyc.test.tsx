...
describe("completeness", () => {
  it("says what is still missing rather than only a percentage", () => {
    ...
    expect(screen.getByText(/2 of 6 on file/)).toBeInTheDocument();
    expect(screen.getByText(/Still needed:/)).toHaveTextContent("Photograph");
    expect(screen.getByText(/Still needed:/)).toHaveTextContent("Aadhaar");
  });
});
