                    ...
                    <div className="flex items-center justify-between text-[10px] text-muted-foreground">
                      ...
                      {l.lastUpdated?.seconds && (
                        <span className="font-mono">
                          {new Date(l.lastUpdated.seconds * 1000).toLocaleDateString("en-IN", { day: "2-digit", month: "2-digit" })}
                        </span>
                      )}
                    </div>
                    <div className="flex gap-2">
                      <a href={getCallUrl(l.phone)} className="flex-1 h-7 rounded-md bg-info/10 text-info text-[10px] font-medium flex items-center justify-center gap-1">
                        <Phone size={10} /> Call
                      </a>
                      <a href={getWhatsAppUrl(l.phone)} target="_blank" rel="noopener noreferrer" className="flex-1 h-7 rounded-md bg-success/10 text-success text-[10px] font-medium flex items-center justify-center gap-1">
